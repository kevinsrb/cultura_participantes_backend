...
dotenv.config(); // NOMBRE DE BASE DE DATOS CULTURA , NOMBRE DE USUARIO, PASSWORD
...
var sequelizeconfig = new _sequelize["default"](process.env.DB_NAME, process.env.DB_USER, process.env.DB_PASSWORD, {
